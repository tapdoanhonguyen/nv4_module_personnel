...
<div id="content">
    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post"  enctype="multipart/form-data" id="form-allowances" class="form-horizontal">
				<input type="hidden" name ="data_id" value="{DATA.data_id}" />
				<input name="save" type="hidden" value="1" />
 
				<div class="form-group required">
					<label class="col-sm-4 control-label" for="input-title">{LANG.allowances_title}</label>
					<div class="col-sm-20">
						<input type="text" name="title" value="{DATA.title}" placeholder="{LANG.allowances_title}" id="input-titles" class="form-control" />
						<!-- BEGIN: error_title --><div class="text-danger">{error_title}</div><!-- END: error_title -->
					</div>
				</div> 
 
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-status">{LANG.allowances_status}</label>
					<div class="col-sm-20">
...
$(document).ready(function() {
 	$('#form-allowances').on('submit', function() {
