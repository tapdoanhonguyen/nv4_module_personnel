	...
	<div class="modal-dialog modal-lg modal-dialog-centered">
	  <div class="modal-content">
		...
		<div class="modal-footer text-center">
			<button type="button" data-submit data="0" class="btn btn-danger btn-sm"><i class="fas fa-file-export"></i> Xuất dữ liệu loại hợp đồng đã chọn</button>
...
$('button[data-submit]').on('click', function(){
	...
	$.ajax({
		...
		method: 'post',
		data: {exportlist: $('#exportlist').val(), contract_type : contract_type, all : all, {TOKENKEY} : '{TOKEN}'},
		dataType: 'json',
		beforeSend: function() {
